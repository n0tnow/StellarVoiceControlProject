...
| 2026-09-19 | `polaris_guard` **v0.2 hardening** (one batched redeploy, after slice works) | worker TBD | planned | [`backlog/guard-v0.2-hardening.md`](backlog/guard-v0.2-hardening.md) | P2 |
