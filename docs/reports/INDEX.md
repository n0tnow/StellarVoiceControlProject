...
| 2026-09-19 | Modifier-only hotkey (Control+Option hold/release) via flagsChanged + objc2 | research worker (modifier-research) | [docs/reports/2026-09-19-modifier-only-hotkey.md](2026-09-19-modifier-only-hotkey.md) | macos, hotkey, flagschanged, nsevent, objc2, accessibility, voiceover, push-to-talk |
