...
/** The active account, as the session reports it. Never a secret. */
export interface WalletSessionActive {
  address: string;
  label: string;
}

/** `wallet_session` result and `wallet_session_changed` payload. */
export interface WalletSession {
  state: WalletSessionState;
  active: WalletSessionActive | null;
  count: number;
